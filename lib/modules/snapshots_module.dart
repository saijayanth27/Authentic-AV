          ...
          ElevatedButton(
            ...
            onPressed: () async {
              if (titleCtrl.text.isNotEmpty) {
                ...
                await AppState.instance.addSnapshot(newSnapshot);
      ...
      builder: (context, _, child) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            backgroundColor: AppTheme.backgroundLight,
            elevation: 0,
            title: const Text('Routing Snapshots', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            leading: IconButton(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: OutlinedButton(
                                    onPressed: () async {
                                      await AppState.instance.deleteSnapshot(index);
                                    },
